    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 text-center ">
                                <h2 class="text-warning fw-bold">New Tech</h2>
                            </div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <span class="text-primary">__@gmail.com</span>
                                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        ...
                                        <td class="fs-6 text-end bg-warning text-white ">Rs. X00000 .00</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
            ...
            <div class="col-12 mb-1 btn-toolbar justify-content-end">
                <button class="btn btn-warning me-2">Print</button>
                <button class="btn btn-dark me-2">Export as PDF</button>
            </div>
        </div>
    </div>
